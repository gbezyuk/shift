...
document.write('<style type="text/css">.changelist-results > table { display: none }</style>');
...
feincms.jQuery(function($){
    ...
    function expandOrCollapseNode(item) {
        ...
        $('.changelist-results > table tbody').recolorRows();
    }
    ...
    $.extend($.fn.bindCollapseTreeEvent = function() {
        $(this).click(function() {
            rlist = $(".changelist-results > table");
            rlist.hide();
