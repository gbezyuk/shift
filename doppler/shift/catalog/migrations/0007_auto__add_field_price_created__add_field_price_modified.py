...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Price.created'
        db.add_column('catalog_price', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 5, 16, 9, 23, 48, 893025), blank=True), keep_default=False)

        # Adding field 'Price.modified'
        db.add_column('catalog_price', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 5, 16, 9, 24, 1, 989348), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Price.created'
        db.delete_column('catalog_price', 'created')

        # Deleting field 'Price.modified'
        db.delete_column('catalog_price', 'modified')
