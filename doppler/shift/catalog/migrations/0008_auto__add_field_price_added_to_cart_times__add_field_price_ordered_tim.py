...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Price.added_to_cart_times'
        db.add_column('catalog_price', 'added_to_cart_times', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Price.ordered_times'
        db.add_column('catalog_price', 'ordered_times', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Price.added_to_cart_times'
        db.delete_column('catalog_price', 'added_to_cart_times')

        # Deleting field 'Price.ordered_times'
        db.delete_column('catalog_price', 'ordered_times')
