...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Price.remainder'
        db.add_column('catalog_price', 'remainder', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Changing field 'Price.value'
        db.alter_column('catalog_price', 'value', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):
        
        # Deleting field 'Price.remainder'
        db.delete_column('catalog_price', 'remainder')

        # Changing field 'Price.value'
        db.alter_column('catalog_price', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=3))
