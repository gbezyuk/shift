...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Price.reserved'
        db.add_column('catalog_price', 'reserved',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Price.reserved'
        db.delete_column('catalog_price', 'reserved')
    ...
    models = {
        ...
        'catalog.price': {
            ...
            'reserved': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
