...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('checkout_order', (
            ...
            ('customer_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('customer_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
            ('customer_email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('delivery_address', self.gf('django.db.models.fields.TextField')(default='')),
        ...
        db.create_table('checkout_orderitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['checkout.Order'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orders', to=orm['catalog.Product'])),
