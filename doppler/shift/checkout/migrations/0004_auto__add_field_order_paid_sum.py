...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.paid_sum'
        db.add_column('checkout_order', 'paid_sum',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.paid_sum'
        db.delete_column('checkout_order', 'paid_sum')
    ...
    models = {
        ...
        'checkout.order': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'paid_sum': ('django.db.models.fields.PositiveIntegerField', [], {}),
